...
from openmoa.base import BatchClassifier, Classifier
...
from openmoa.ocl.base import TaskAware, TaskBoundaryAware
from openmoa.type_alias import LabelIndex
...
class OCLMetrics:
    ...
    :attr:`openmoa.evaluation.results.PrequentialResults.windowed`.
    """
