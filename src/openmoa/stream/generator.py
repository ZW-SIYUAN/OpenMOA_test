...
class HyperPlaneClassification(MOAStream):
    ...
    >>> from openmoa.stream.generator import HyperPlaneClassification
    ...
...
class HyperPlaneRegression(MOAStream):
    ...
    >>> from openmoa.stream.generator import HyperPlaneRegression
    ...
...
class RandomRBFGenerator(MOAStream):
    ...
    >>> from openmoa.stream.generator import RandomRBFGenerator
    ...
...
class AgrawalGenerator(MOAStream):
    ...
    >>> from openmoa.stream.generator import AgrawalGenerator
    ...
...
class LEDGenerator(MOAStream):
    ...
    >>> from openmoa.stream.generator import LEDGenerator
    ...
    >>> stream = LEDGenerator()
    >>> stream.next_instance()
    LabeledInstance(
...
class LEDGeneratorDrift(MOAStream):
    ...
    >>> from openmoa.stream.generator import LEDGeneratorDrift
    ...
...
class WaveformGeneratorDrift(MOAStream):
    ...
    >>> from openmoa.stream.generator import WaveformGeneratorDrift
    ...
...
class STAGGERGenerator(MOAStream):
    ...
    >>> from openmoa.stream.generator import STAGGERGenerator
    ...
...
class SineGenerator(MOAStream):
    ...
    >>> from openmoa.stream.generator import SineGenerator
    ...
