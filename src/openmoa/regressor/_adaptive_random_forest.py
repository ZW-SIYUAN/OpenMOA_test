...
from openmoa.base import MOARegressor, _extract_moa_learner_CLI
...
class AdaptiveRandomForestRegressor(MOARegressor):
    ...
    See also :py:class:`openmoa.classifier.AdaptiveRandomForestClassifier`
    See :py:class:`openmoa.base.MOARegressor` for train and predict.
    ...
    >>> from openmoa.regressor import AdaptiveRandomForestRegressor
