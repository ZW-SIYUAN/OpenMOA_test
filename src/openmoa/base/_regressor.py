...
from openmoa.instance import Instance, RegressionInstance
from openmoa.stream._stream import Schema
from openmoa.type_alias import TargetValue
...
class BatchRegressor(Regressor):
    ...
    >>> from openmoa.base import BatchRegressor
    >>> from openmoa.datasets import FriedTiny
...
class SKRegressor(Regressor):
    """A wrapper class for using scikit-learn regressors in OpenMOA.

    Some of scikit-learn's regressors that are compatible with online learning
    have been wrapped and tested already in OpenMOA (See :mod:`openmoa.regressor`).
    ...
    See also :class:`openmoa.base.SKClassifier` for scikit-learn classifiers.
    """
