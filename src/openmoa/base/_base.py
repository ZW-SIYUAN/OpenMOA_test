...
from openmoa.base._classifier import MOAClassifier
from openmoa.base._regressor import MOARegressor, Regressor
...
class MOAClusterer(Clusterer):
    """
    A wrapper class for using MOA (Massive Online Analysis) clusterers in OpenMOA.
