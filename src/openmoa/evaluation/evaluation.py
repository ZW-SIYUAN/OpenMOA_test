...
from openmoa._utils import _translate_metric_name, batched
...
from openmoa.evaluation._progress_bar import resolve_progress_bar
from openmoa.evaluation.results import PrequentialResults
...
class ClassificationEvaluator:
    ...
    def metrics_header(self):
        ...
        performance_names = [
            _translate_metric_name("".join(measurement.getName()), to="openmoa")
...
class ClusteringEvaluator:
    """
    Abstract clustering evaluator for OpenMOA.
