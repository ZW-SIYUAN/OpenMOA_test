...
OpenMOA provides a Docker image application containing a ready-to-go Jupyter
notebook. If you require a reproducible environment or want to experiment with
OpenMOA and have experience with Docker, this is the best place to begin.
...
![Image of OpenMOA Jupyter Notebook](images/docker_demo.png)
...
services:
  jupyter-openmoa:
    image: tachyonic/jupyter-openmoa
    ports:
      - "8888:8888"
    volumes:
