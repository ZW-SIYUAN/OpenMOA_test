...
This document outlines the version control practices used in the OpenMOA project.
...
OpenMOA uses the [ruff](https://astral.sh/ruff) linter to enforce both.
...
OpenMOA uses conventional commit messages to streamline the release process.
